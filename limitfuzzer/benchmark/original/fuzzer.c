...
const char* pool_element[] =  {"false", "true", "null"};
const int pool_l_element[] =  {5, 4, 4};
        

const char* pool_value[] =  {"true", "null", "false"};
...
const char* pool_character[] =  {"W", "e", "T", "t", "M", "7", "d", "y", "Y", "|", " ", "%", "}", "?", "D", "i", "Q", "E", "o", "1", "@", "p", "^", "J", "u", "#", "8", "k", "v", "P", "*", "/", "s", "5", "$", "O", "9", "I", "X", "r", "[", "&", "z", "Z", ".", ":", "C", "!", "6", "(", "{", "<", "3", "-", "+", "=", "c", "4", "L", "H", "g", "N", "x", "G", ";", "b", "`", "m", "0", "w", "2", "'", "U", "A", "l", "a", "V", "h", ")", "j", ",", "~", "f", "B", "F", ">", "K", "_", "n", "q", "R", "S", "]"};
...
const char* pool_esc[] =  {"\\f", "\\\"", "\\b", "\\n", "\\\\", "\\r", "\\t"};
const int pool_l_esc[] =  {2, 2, 2, 2, 2, 2, 2};
        

const char* pool_escc[] =  {"t", "\\", "r", "\"", "b", "f", "n"};
...
const char* pool_onenine[] =  {"8", "6", "7", "9", "4", "5", "3", "1", "2"};
...
const char* pool_symbol[] =  {",\"\":false", ",\"\":true", ",\"\":null"};
